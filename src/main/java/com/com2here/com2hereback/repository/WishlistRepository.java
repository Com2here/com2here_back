...
public interface WishlistRepository extends JpaRepository<Wishlist, Long> {
    ...
    boolean existsByUserAndProduct_NaverProductId(User user, Long naverProductId);
    Optional<Wishlist> findByUserAndProduct_NaverProductId(User user, Long naverProductId);
}
